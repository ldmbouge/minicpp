...
WARN = -Wnon-modular-include-in-framework-module -Werror=non-modular-include-in-framework-module -Wno-trigraphs \
	-Wno-missing-field-initializers -Wno-missing-prototypes -Werror=return-type -Wno-documentation -Wunreachable-code \
	...
	-Wno-range-loop-analysis -Wno-semicolon-before-method-body -Wunguarded-availability \
