...
public:
    ...
    auto propagateOnBind(Constraint::Ptr c)          { return _onBindList.push_back(c);}
    auto propagateOnBoundChange(Constraint::Ptr c)   { return _onBoundsList.push_back(c);}
    auto propagateOnDomainChange(Constraint::Ptr c ) { return _onDomList.push_back(c);}
