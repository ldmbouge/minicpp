...
GFL_HOST_DEVICE constexpr double div(T1 const a, T2 const b) {
    static_assert(std::is_integral_v<T1>);
    static_assert(std::is_integral_v<T2>);
    assert(b != 0);
    double const _a = scast<double>(a);
    double const _b = scast<double>(b);
    return _a / _b;
}

// Ceiling division: (a + b - 1) / b
template<typename TOut, typename T1, typename T2>
GFL_HOST_DEVICE constexpr TOut ceilDiv(T1 const a, T2 const b) {
    static_assert(std::is_integral_v<T1>);
    static_assert(std::is_integral_v<T2>);
...
template<typename TOut, typename T1, typename T2>
GFL_HOST_DEVICE constexpr TOut roundDown(T1 const a, T2 const b) {
    static_assert(std::is_integral_v<T1>);
    static_assert(std::is_integral_v<T2>);
    static_assert(std::is_integral_v<TOut>);
    if constexpr (not std::is_unsigned_v<T1>)
        assert(a >= 0);
    assert(b > 0);
    using TComm = std::common_type_t<T1, T2>;
    TComm const a_ = scast<TComm>(a);
...
template<typename TOut, typename T1, typename T2>
GFL_HOST_DEVICE constexpr TOut roundUp(T1 const a, T2 const b) {
    static_assert(std::is_integral_v<T1>);
    static_assert(std::is_integral_v<T2>);
    static_assert(std::is_integral_v<TOut>);
    if constexpr (not std::is_unsigned_v<T1>)
...
template<typename TOut, typename T1, typename T2>
GFL_HOST_DEVICE constexpr TOut min(T1 const a, T2 const b) {
...
GFL_HOST_DEVICE constexpr TOut min(T1 const a, T2 const b, TRest const... rest) {
...
template<typename TOut, typename T1, typename T2>
GFL_HOST_DEVICE constexpr TOut max(T1 const a, T2 const b) {
    static_assert(std::is_arithmetic_v<T1>);
    static_assert(std::is_arithmetic_v<T2>);
    static_assert(std::is_arithmetic_v<TOut>);
    using TComm = std::common_type_t<T1, T2>;
...
template<typename TOut, typename T1, typename T2, typename... TRest>
GFL_HOST_DEVICE constexpr TOut max(T1 const a, T2 const b, TRest const... rest) {
    static_assert((std::is_arithmetic_v<TRest> && ...));
