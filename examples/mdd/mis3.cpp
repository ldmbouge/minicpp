...
int main(int argc,char* argv[])
{
   ...
   sumMDD(mdd->getSpec(),x,{5,4,2,6,8},z);
   sumMDD(mdd->getSpec(),{x[0],x[1]},{1,1},0, 1);
   sumMDD(mdd->getSpec(),{x[0],x[4]},{1,1},0, 1);
   sumMDD(mdd->getSpec(),{x[1],x[2]},{1,1},0, 1);
   sumMDD(mdd->getSpec(),{x[1],x[3]},{1,1},0, 1);
   sumMDD(mdd->getSpec(),{x[2],x[3]},{1,1},0, 1);
   sumMDD(mdd->getSpec(),{x[3],x[4]},{1,1},0, 1);
   cp->post(mdd);
