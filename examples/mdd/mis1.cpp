...
int main(int argc,char* argv[])
{
   ...
   mdd->post(sum(mdd,x,{5,4,2,6,8},12,12));
   mdd->post(sum(mdd,{x[0],x[1]},{1,1},0, 1));
   mdd->post(sum(mdd,{x[0],x[4]},{1,1},0, 1));
   mdd->post(sum(mdd,{x[1],x[2]},{1,1},0, 1));
   mdd->post(sum(mdd,{x[1],x[3]},{1,1},0, 1));
   mdd->post(sum(mdd,{x[2],x[3]},{1,1},0, 1));
   mdd->post(sum(mdd,{x[3],x[4]},{1,1},0, 1));
   cp->post(mdd);
