...
void buildModel(CPSolver::Ptr cp, int relaxSize, int mode, int maxRebootDistance, int maxSplitIter, int constraintSet, int horizonSize, int nodePriority, int nodePriorityAggregateStrategy, int candidatePriority, int candidatePriorityAggregateStrategy, bool useApproxEquiv, bool approxThenExact, int approxEquivMode, int equivalenceThreshold, int maxWorkConstraintPriority, int minWorkConstraintPriority, int weeklyWorkConstraintPriority, bool sameMDD)
{
  ...
  if (mode == 0) {
	...
	cout << j << " ";
      ...
      addMDDConstraint(cp, mdd, relaxSize, maxRebootDistance, maxSplitIter, nodePriorityAggregateStrategy, candidatePriorityAggregateStrategy, useApproxEquiv, approxThenExact, maxConstraintPriority, sameMDD, [adv, L1, U1, workDay, nodePriority, candidatePriority, approxEquivMode, equivalenceThreshold, maxWorkConstraintPriority](MDDRelax* mdd) { 
        Factory::amongMDD2(mdd->getSpec(), adv, L1, U1, workDay, nodePriority, candidatePriority, approxEquivMode, equivalenceThreshold, maxWorkConstraintPriority);
      });
    }
	...
	cout << j << " ";
      ...
      auto adv = all(cp, amongVars, vars);
      addMDDConstraint(cp, mdd, relaxSize, maxRebootDistance, maxSplitIter, nodePriorityAggregateStrategy, candidatePriorityAggregateStrategy, useApproxEquiv, approxThenExact, maxConstraintPriority, sameMDD, [adv, L2, U2, workDay, nodePriority, candidatePriority, approxEquivMode, equivalenceThreshold, minWorkConstraintPriority](MDDRelax* mdd) { 
        Factory::amongMDD2(mdd->getSpec(), adv, L2, U2, workDay, nodePriority, candidatePriority, approxEquivMode, equivalenceThreshold, minWorkConstraintPriority);
      });
    }
	...
	auto adv = all(cp, amongVars,vars);
        addMDDConstraint(cp, mdd, relaxSize, maxRebootDistance, maxSplitIter, nodePriorityAggregateStrategy, candidatePriorityAggregateStrategy, useApproxEquiv, approxThenExact, maxConstraintPriority, sameMDD, [adv, L3, U3, workDay, nodePriority, candidatePriority, approxEquivMode, equivalenceThreshold, weeklyWorkConstraintPriority](MDDRelax* mdd) { 
	  Factory::amongMDD2(mdd->getSpec(), adv, L3, U3, workDay, nodePriority, candidatePriority, approxEquivMode, equivalenceThreshold, weeklyWorkConstraintPriority);
        });
      }
    }
  }
	...
	auto adv = all(cp,amongVars,vars);
        addMDDConstraint(cp, mdd, relaxSize, maxRebootDistance, maxSplitIter, nodePriorityAggregateStrategy, candidatePriorityAggregateStrategy, useApproxEquiv, approxThenExact, maxConstraintPriority, sameMDD, [adv, L3, U3, workDay, nodePriority, candidatePriority, approxEquivMode, equivalenceThreshold](MDDRelax* mdd) { 
	  Factory::amongMDD2(mdd->getSpec(), adv, L3, U3, workDay, nodePriority, candidatePriority, approxEquivMode, equivalenceThreshold);
        });
      }
    }
  }
